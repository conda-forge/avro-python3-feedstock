...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/avro-python3-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14480&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/avro-python3-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `avro-python3` can be installed with:

```
conda install avro-python3
```

It is possible to list all of the versions of `avro-python3` available on your platform with:
